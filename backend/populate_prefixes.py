#!/usr/bin/env python
"""
One-time script to populate municipality prefixes
Run this with: python populate_prefixes.py
"""
import os
import django

# Setup Django
os.environ.setdefault('DJANGO_SETTINGS_MODULE', 'bangka.settings')
django.setup()
...
def populate_prefixes():
    ...
    for municipality in Municipality.objects.all():
        ...
        if municipality.prefix and len(municipality.prefix) == 3:
...
if __name__ == '__main__':
    print("Populating municipality prefixes...\n")
    populate_prefixes()
