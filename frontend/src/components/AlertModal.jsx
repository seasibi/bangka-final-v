...
const AlertModal = ({ isOpen, onClose, title, message, variant }) => {
  useEffect(() => {
    if (isOpen) {
      ...
      {isOpen && (
        <div className="fixed inset-0 z-[9999] flex items-center justify-center p-4" onClick={handleBackdropClick}>
          ...
          <motion.div
            ...
            className="bg-white rounded-2xl w-full max-w-md overflow-hidden shadow-xl relative z-[10000]"
          >
            {/* Content */}
            ...
            <div className="flex justify-center px-6 pb-6">
              <button
                onClick={onClose}
                className={`px-8 py-2 text-sm font-medium text-white rounded-lg transition-colors ${
