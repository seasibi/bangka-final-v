...
import municipalAgriService from "../../services/municipalAgriService";
import { useAuth } from "../../contexts/AuthContext";

const EditMunicipalAgriculturist = () => {
  ...
  const [formData, setFormData] = useState({
    ...
    contact_number: "",
    is_active: true,
    user_role: "municipal_agriculturist", // ensure this is set
    position: "",
    sex: "",
  });
  ...
  const fetchAgriculturistData = async () => {
    try {
      ...
      const response = await municipalAgriService.get(id);
      ...
      if (!fetched.user_role) {
        fetched.user_role = "municipal_agriculturist";
      }
      setFormData(fetched);
      setLoading(false);
    } catch (error) {
  ...
  const handleReviewConfirm = async () => {
    ...
    try {
      ...
      await municipalAgriService.update(id, payload);
  ...
  const handleConfirmCancel = () => {
    ...
    navigate("/admin/municipalAgriManagement");
  };
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <div className="flex items-center mb-6">
        <Button
          type="button"
          onClick={() => navigate("/admin/municipalAgriManagement")}
          variant="icon"
        >
          {/* Back icon */}
          <svg
      ...
      <Modal
        ...
        message={
          <div>
            ...
            <div>
              <strong>Municipality:</strong> {formData.municipality}
            </div>
            <div>
      ...
      <SuccessModal
        ...
        message="Municipal Agriculturist has been successfully updated!"
        onClose={() => {
...
export default EditMunicipalAgriculturist;
