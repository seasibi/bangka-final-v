...
const AdminDashboard = () => {
  ...
  return (
    <div className="bg-gray-50 min-h-screen px-4 md:px-6 py-6 font-sans" style={{ fontFamily: "Montserrat, sans-serif" }}>
      <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 grid-rows-1 mt-1">
            <div className="flex items-center gap-2">
              ...
              <input
                ...
                className="text-sm p-2 rounded-md border-gray-200 shadow-sm focus:border-blue-500 focus:ring focus:ring-blue-200"
              />
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6 pb-4 mt-5">
          ...
          <div className="bg-white rounded-2xl shadow-lg p-5 flex flex-col justify-center transform transition-all hover:-translate-y-1 hover:shadow-2xl">
            ...
            <p className="text-sm text-gray-600 mb-3">Fisherfolk registered by sex</p>
          ...
          <div className="bg-white rounded-2xl shadow-lg p-5 flex flex-col justify-center transform transition-all hover:-translate-y-1 hover:shadow-2xl">
            ...
            <p className="text-sm text-gray-600 mb-3">Fisherfolk registered by main livelihood</p>
          ...
          <div className="bg-white rounded-2xl shadow-lg p-5 flex flex-col justify-center items-center transform transition-all hover:-translate-y-1 hover:shadow-2xl">
            ...
            <p className="text-sm text-gray-600 mb-3">Trackers created, assigned vs unassigned</p>

            <TrackerDonutStat startDate={startDate} endDate={endDate} />
          </div>

          {/* Row 2: Boats (wide) + Violations */}
          <div className="bg-white rounded-2xl shadow-lg p-5 flex flex-col justify-center transform transition-all hover:-translate-y-1 hover:shadow-2xl xl:col-span-2">
            ...
            <p className="text-sm text-gray-600 mb-1">Boats registered by municipality & type</p>
