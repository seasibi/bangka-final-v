        ...
        <div className="flex items-center mb-3 mt-2">
          ...
          <div className="grid grid-cols-1 grid-rows-2 ml-4">
            ...
            <p className="text-base text-gray-700" style={{ fontFamily: "Montserrat, sans-serif" }}>
              Create full SQL backups using the Backup utility. When restoring, upload .sql files only — do not upload debug JSON. Backups are named using the pattern BANGKA_DBBackup_YYYY-MM-DD_HH-MM-SS.sql.
            </p>
          </div>
        </div>
      </div>
