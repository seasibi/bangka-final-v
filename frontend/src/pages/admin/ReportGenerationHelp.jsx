        ...
        <div className="flex items-center mb-3 mt-2">
          ...
          <div className="grid grid-cols-1 grid-rows-2 ml-4">
            ...
            <p className="text-base text-gray-700" style={{ fontFamily: "Montserrat, sans-serif" }}>
              Steps to generate Fisherfolk, Boat, and Activity Log reports. Use filters and export options to customize output.
            </p>
          </div>
        </div>
      </div>
...
export default ReportGenerationHelp