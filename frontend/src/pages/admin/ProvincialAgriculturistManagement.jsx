...
const AdminProvincialAgriManagement = () => {
    ...
    try {
      ...
      try {
        await logActivity({
          ...
          description: 'Retrieved all provincial agriculturist records'
        });
      } catch (logErr) {
        console.error('Activity log failed:', logErr);
      }

      setAgriculturists(response.data.filter(user => user.user_role === 'provincial_agriculturist' && user.is_active === true));
  ...
  const handleEdit = async () => {
    ...
    try {
      const provincialAgriId = selectedAgri.provincial_agriculturist.provincial_agriculturist_id;
      console.log("Selected Provincial Agriculturist ID:", provincialAgriId);
      setIsEditModalOpen(false);
      navigate(`/admin/provincial-agriculturist/edit/${provincialAgriId}`, {
    ...
    <div className="h-full bg-gray-50">
      <div className="h-full px-4 py-7">
        <div className="flex justify-between items-center mb-6">
          <PageTitle value="Provincial Agriculturist Management" />
      </div>
      ...
      <div className="bg-white rounded-lg shadow overflow-y-auto h-[50vh] sm:h-[60vh] md:h-[65vh] lg:h-[70vh] xl:h-[70vh] 2xl:h-[76vh] w-full">
              ...
              {agriculturists.length === 0 ? (
                <tr>
                  <td colSpan="5" className="px-6 py-4 text-center text-gray-500">
                    No provincial agriculturists found
                  </td>
                </tr>
              ) : (
        ...
        <Modal
          ...
          title="Edit User"
          message={
            selectedAgri && selectedAgri.provincial_agriculturist
              ? `Are you sure you want to edit ${selectedAgri.provincial_agriculturist.first_name} ${selectedAgri.provincial_agriculturist.middle_name} ${selectedAgri.provincial_agriculturist.last_name}'s information?`
...
export default AdminProvincialAgriManagement;