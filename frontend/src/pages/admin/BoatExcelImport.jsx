...
const BoatExcelImport = () => {
  ...
  const handleConfirmImport = async () => {
    ...
    try {
      const res = await axios.post(`${API_BASE}/api/boats/import-excel/`, formData, {
        headers: {
  ...
  return (
    <div className="min-h-screen bg-gray-50 p-6">
          ...
          {result && (
            <div className="mt-6 p-4 rounded-lg border" style={{
              ...
              {result.error ? (
                ...
                <div>
                  <div className="text-green-700 font-medium mb-2">✓ Successfully imported {result.imported} boat records</div>
      ...
      <ConfirmModal
        ...
        message="Are you sure you want to import boats from this Excel file?"
      />
      ...
      <SuccessModal
        ...
        message={`Successfully imported ${result?.imported || 0} boat records!`}
      />
    </div>
  );
};

export default BoatExcelImport;
