...
setLastFisherfolk(data.fisherfolk_registration_number
    ? {
    ...
    // Optionally log activity (if needed, can be moved to backend or BoatRegistrationForm)
    // try {
    //   await logActivity({
    //     type: 'create',
    //     action: `Registered new boat: ${data.boat.boat_name || 'Unnamed'} by ${data.fisherfolk_registration_number}`,
    //   });
    // } catch (logErr) {
