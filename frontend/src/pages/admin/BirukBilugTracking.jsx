...
<div className="grid grid-cols-1 grid-rows-2 ml-2">
        ...
        {/* Map Container */}
<div className="relative bg-white rounded-lg shadow overflow-hidden h-[50vh] sm:h-[60vh] md:h-[65vh] lg:h-[70vh] xl:h-[70vh] 2xl:h-[72vh] w-full">          
          <MapView boundaryType={boundaryType} searchMfbr={searchMfbr}/>
        {/* Controls */}
          <div className="absolute top-4 right-4 z-10 bg-white/90 p-4 rounded-xl shadow-md w-64 space-y-3 pointer-events-auto">
...
export default AdminBirukBilugTracking;
