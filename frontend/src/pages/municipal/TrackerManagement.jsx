                    ...
                    return (
                      <tr key={tracker.BirukBilugID} className={rowIndex % 2 === 0 ? 'bg-white' : 'bg-gray-50'}>
                        ...
                        <td className="px-6 py-4 whitespace-nowrap text-sm">
                          <button className="px-3 py-1 rounded bg-blue-600 text-white hover:bg-blue-700" onClick={() => navigate(`/municipal_agriculturist/TrackerManagement/view/${encodeURIComponent(tracker.BirukBilugID)}`)}>View Tracker</button>
                        </td>
                      </tr>
                    );
                  })
